                                ...
                                <div class = "row">
                                    ...
                                    <div class="col-sm-6">      
                                        ...
                                        <label>Lattitude</label>
                                            <input type = "text" class = "form-control" name = "lat_dinas" value ="<?php echo $row->lat_dinas;?>"> 
                                        </div>
                                    </div>
                                </div>
                                <div class = "row">
                                    <div class="col-sm-6">      
                                        ...
                                        <label>Longitude</label>
                                            <input type = "text" class = "form-control" name = "long_dinas" value ="<?php echo $row->long_dinas;?>"> 
                                        </div>
                                    </div>
                                </div>
